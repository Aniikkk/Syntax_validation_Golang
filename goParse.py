# GOlang
# Variable declaration, switch case, if statement, array declaration and function declaration
...
def p_function_definition(p):
    '''function_definition : FUNCTION ID LPAREN defparameters RPAREN LBRACE program RBRACE
    '''
...
def p_defparameters(p):
    '''defparameters : defparameter COMMA defparameters
                     | defparameter
                     | empty
    '''
    if len(p) == 2:
...
def p_defparameter(p):
    '''defparameter : ID type_specifier
    '''
    p[0] = (p[1], p[2])
